...
public class Logic {
	...
	public int Moveornot(Panel p,combination c,int drect,int move)
	{
		for(int i=0;i<4;i++)
		{
			if(drect == VERTICAL)
	...
	public int Turnornot(Panel p,combination c)
	{
	...
	public int Gameover(Panel p,combination c)
	{
	...
	//判断第num行是否需要清0
	public int cleanornot(Panel p,int num)
	{
		int count = 0;
